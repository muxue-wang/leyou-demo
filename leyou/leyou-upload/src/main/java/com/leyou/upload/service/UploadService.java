...
public class UploadService {
    ...
    public String uploadImage(MultipartFile file) {
        ...
        try {
            ...
            final String s = StringUtils.substringAfterLast(originalFilename, ".");
            final StorePath storePath = this.storageClient.uploadFile(file.getInputStream(), file.getSize(), s, null);
